...
def update_question(request, eventId, questionId):
    if request.method != "PUT":
        return JsonResponse({"success": False, "message": "método invalido"},
    ...
    if existing_events.exists():
        ...
        if question_db:
            ...
            event_answers = event.eventanswer_set.filter(question=question_db)
            ...
            return JsonResponse({"success": True,
                                 "message":
                                 "Pergunta duplicada e associada com sucesso"},
